...
export default function MacroPage() {
  ...
  const totalAgents = progress[0]?.total_agents ?? 2;
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Panorama da economia brasileira — Selic, IPCA, câmbio, fiscal e
          impactos setoriais gerado por agentes de IA.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
          ...
          <button
            ...
            disabled={isRunning ? false : false}
            className={`
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-6 space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-blue-400">
              {completedCount}/{totalAgents} etapas
            </span>
          </div>
