...
export default function SwarmPage() {
  ...
  const totalAgents = progress[0]?.total_agents ?? 12;

  return (
    <div className="mx-auto max-w-6xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-white">Ultra-Análise Swarm</h1>
        <p className="mt-1 text-sm text-slate-400">
          Análise profunda com 12 agentes de IA em 4 ondas — coleta, análise
          especializada, advogado do diabo e síntese final.
        </p>
      </div>
      ...
      {/* Overall Progress */}
      {(isRunning || progress.length > 0) && !result && (
